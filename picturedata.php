...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    header('Location:picturedata.php');
    exit();
}
?>
...
<html lang="ja">
  ...
  <script src="https://kit.fontawesome.com/c037f9dfd1.js" crossorigin="anonymous"></script> 
...
<div class="modal carousel slide" id="lightbox" tabindex="-1" role="dialog" data-ride="carousel" styel="position:fixed;">
